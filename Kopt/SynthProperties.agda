...
private
  ...
  gp-ok-props : (t : Pos4) (e : Phase4) (c : Circuit) -> gp-ok? t e c ≡ true ->
                GPCircuit (gp-mat-of t e) c
  gp-ok-props t e c h with ∧-true₅ h
  ... | (p₁ , p₂ , p₃ , p₄ , p₅) =
        gp-props (gpd-sem-sound t e c (sem-gpd c) (sem-gpd-sound c) p₁)
                 (≤ᵇ⇒≤ p₂) (≡ᵇ⇒≡ p₃) (≤ᵇ⇒≤ p₄) p₅
...
gperm-of-gp G = c , gperm-of-gp-mat (gp-pos G) (gp-ph G) (gp-distinct G)
